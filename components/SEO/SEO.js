...
const SEO = () => {
  return (
    <Head>
      ...
      <meta name='image' content='/assets/website.png' key='ogtitle' />
      <meta property='og:title' content='Astroneir Design' key='ogtitle' />
      <meta
      ...
      <meta
        ...
        key='twdescription'
      />
      <meta name='twitter:image' content='/assets/website.png' key='twimage' />
      <meta property='og:url' content='www.astroneir-design.com' key='ogurl' />
      <meta property='og:image' content='/assets/website.png' key='ogimage' />
      <meta
